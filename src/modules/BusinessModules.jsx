  ...
  const descargarExcel = async q => {
    ...
    try {
      ...
      const detailRows = [
        ...
        [{ value: 'Valor venta', style: 2 }, { value: num(q.subtotal), numeric: true, style: 7 }, { value: 'Descuento', style: 2 }, { value: num(q.descuento), numeric: true, style: 7 }],
